...
namespace Gabbetto.Word.Web.Server.Migrations
{
    ...
    [Migration("20200618112429_AddedTheWebSocketClientDataModel")]
    partial class AddedTheWebSocketClientDataModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gabbetto.Word.Web.Server.WebSocketClient", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Gabbetto.Word.Web.Server.WebSocketConnection", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Gabbetto.Word.Web.Server.WebSocketGroup", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Gabbetto.Word.Web.Server.WebSocketGroupClient", b =>
                {
                    b.Property<string>("WebSocketClientId");

                    b.Property<string>("WebSocketGroupId");

                    b.HasKey("WebSocketClientId", "WebSocketGroupId");

                    b.HasIndex("WebSocketGroupId");
            ...
            modelBuilder.Entity("Gabbetto.Word.Web.Server.WebSocketConnection", b =>
                {
                    b.HasOne("Gabbetto.Word.Web.Server.WebSocketClient", "WebSocketClient")
            ...
            modelBuilder.Entity("Gabbetto.Word.Web.Server.WebSocketGroupClient", b =>
                {
                    b.HasOne("Gabbetto.Word.Web.Server.WebSocketClient", "WebSocketClient")
                        ...
                        .HasForeignKey("WebSocketClientId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Gabbetto.Word.Web.Server.WebSocketGroup", "WebSocketGroup")
                        .WithMany("GroupClients")
                        .HasForeignKey("WebSocketGroupId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
